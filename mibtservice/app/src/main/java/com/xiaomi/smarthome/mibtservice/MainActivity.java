...
public class MainActivity extends Activity {
    ...
    private static final int PRODUCTID = 156;
    ...
    private void sendMessage() {
        if (mMiServiceHandler != null) {
            try {
                mMiServiceHandler.writeBlock("test info", new IMiBTCallback() {
                    @Override
                    public void onCallback(int code, String data) throws RemoteException {
    ...
    private IMiBTCallback mBlockListener = new IMiBTCallback() {
        ...
        @Override
        public void onCallback(int code, String data) throws RemoteException {
            Log.d("MainActivity", "mBlockListener code = " + code + ", data = " + data);
        }
    };
...
//                .addManufacturerData(1, "ab".getBytes())
    ...
    private void startServer() {
        mClient.startGattServer(new MiBTCallback() {
            @Override
            public void onCallback(int code, String msg) throws RemoteException {
