...
A simple, stable and reliable bluetooth framework for android, offers easy access to control bluetooth device
...
```Java
XmPluginHostApi.instance().notifyBluetoothBinded(mac, null);
```
